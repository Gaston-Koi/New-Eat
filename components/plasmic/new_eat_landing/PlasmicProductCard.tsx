...
import Ratings from "../../Ratings"; // plasmic-import: qSeTeuEO5Gvn/component
...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: UKuVUottRK3Z/css

import ShoppingCartIcon from "./icons/PlasmicIcon__ShoppingCart"; // plasmic-import: DsdQ08mwjalU/icon
import HeartOIcon from "./icons/PlasmicIcon__HeartO"; // plasmic-import: mIo2eA2baS5F/icon
import ExpandIcon from "./icons/PlasmicIcon__Expand"; // plasmic-import: XFyaDDFhsSLc/icon
...
function PlasmicProductCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___2JzKz)}>
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__i6COx)}
              displayHeight={"auto"}
              ...
              displayWidth={"100%"}
              src={{
                src: "/plasmic/new_eat_landing/images/f1.jpg",
                fullWidth: 270,
                fullHeight: 310,
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__dzjL0, {
            [sty.freeBoxonSale__dzjL0DXAsf]: hasVariant(
              $state,
              "onSale",
              "onSale"
            )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__tRwgK)}
        >
          <ShoppingCartIcon
            className={classNames(projectcss.all, sty.svg__t9Fvp)}
            role={"img"}
          />
          ...
          <HeartOIcon
            className={classNames(projectcss.all, sty.svg___704Q8)}
            role={"img"}
          />

          <ExpandIcon
            className={classNames(projectcss.all, sty.svg___2VeKx)}
            role={"img"}
          />
        </Stack__>
      </div>
      {renderPlasmicSlot({
        defaultContents: (
          <Ratings
            className={classNames("__wab_instance", sty.ratings__udeIf)}
          />
        ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xktdo)}
      >
        {renderPlasmicSlot({
