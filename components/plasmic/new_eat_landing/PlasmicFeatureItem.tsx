...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: 2cSPlMDBh4xj/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__rIDiL)}>
        <div className={classNames(projectcss.all, sty.freeBox___6BTe9)} />

        <div className={classNames(projectcss.all, sty.freeBox__t0C6)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__hdJmh)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___8FWJ)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__rkCld)}
            >
              <LinkButton
