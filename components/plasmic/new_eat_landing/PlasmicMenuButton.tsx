...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: tAIYu5UZRBll/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: aiM_s93WlEsm/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: 6lV1qlKHT5rk/icon
...
function PlasmicMenuButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <BarsIcon
          className={classNames(projectcss.all, sty.svg___5MV99, {
            [sty.svgexpanded___5MV99VDuPx]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <TimesIcon
          className={classNames(projectcss.all, sty.svg__h1ZNg, {
            [sty.svgexpanded__h1ZNgVDuPx]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
